...
def printGame(ATarget, BTarget):
    print(
        f'Compare A: {ATarget["name"]}, a {ATarget["description"]}, from {ATarget["country"]},{ATarget["follower_count"]}')
    print(art.vs)
    print(
        f'Compare B: {BTarget["name"]}, a {BTarget["description"]}, from {BTarget["country"]}, {BTarget["follower_count"]}')
